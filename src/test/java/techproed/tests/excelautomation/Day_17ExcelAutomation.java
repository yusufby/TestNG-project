...
public class Day_17ExcelAutomation {
...
//an eml file that we create to run specific test cases

/*Why do we use testNG.xml file? */
//we use it to run specific test suites such
// as smoke testing,some end-to-end testing and regression testing
